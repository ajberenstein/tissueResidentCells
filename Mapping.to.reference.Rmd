...
obj <- FindVariableFeatures(obj, selection.method = "vst", nfeatures = 100 , verbose = FALSE)
```
...
p3 = DimPlot(mapped.data, reduction = "ref.umap", group.by = "predicted.celltype.l3", label = TRUE, label.size = 3 ,repel = TRUE) + NoLegend()
